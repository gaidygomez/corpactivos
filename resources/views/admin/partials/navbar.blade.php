    ...
    <div class="container-fluid">
        ...
        <div class="navbar-left">
            <div class="navbar-btn">
                <a href=" {{ route('admin.dashboard')}} "><img src=" {{ asset('img/logo.jpg') }} " alt="CorpActivos Logo" class="img-fluid" width="75" height="100"></a>
                ...
                {{-- <li class="dropdown">
                    ...
                    <ul class="dropdown-menu right_chat email vivify fadeIn">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src=" {{ asset('img/avatar5.jpg') }} " alt="">
                                    <div class="media-body">
        ...
        <div class="navbar-right">
            <div id="navbar-menu">
                <ul class="nav navbar-nav">
                    <li>
                        <a class="icon-menu" data-toggle="tooltip" data-placement="bottom" title="Cerrar Sesión" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); 
