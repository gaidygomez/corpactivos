    ...
    <div class="container-fluid">
        ...
        <div class="navbar-left">
            <div class="navbar-btn">
                <a href=" {{ route('home')}} "><img src=" {{ asset('img/logo.jpg') }} " alt="CorpActivos Logo" class="img-fluid" width="75" height="100"></a>
 ...
 {{--                <li class="dropdown language-menu">
        ...
        <div class="navbar-right">
            <div id="navbar-menu">
                <ul class="nav navbar-nav">
                    <li>
                        <a class="icon-menu" data-toggle="tooltip" data-placement="bottom" title="Cerrar Sesión" href="{{ route('logout') }}" onclick="event.preventDefault(); 
